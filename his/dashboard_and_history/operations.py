...
def get_data(from_date , to_date):
	...
	return [que , bills , sales,from_date, to_date]
...
@frappe.whitelist()
def account_receivable_balance():
	
	abbr = frappe.db.get_value("Company", frappe.defaults.get_user_default("company"), "abbr")
	report_re = frappe.get_doc("Report", "Account Balance")
	report_re_filters = {
	...
	# frappe.errprint(data_re)
	return data_re[0]["balance"]
	acc={}
	res=[]
	debit=0
	credit=0
