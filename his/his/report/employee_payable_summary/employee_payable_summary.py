...
class AccountReceivableSummary(ReceivablePayableReport):
	...
	def get_data(self, args):
		...
		for party, party_dict in iteritems(self.party_total):
			...
			row.statement =f"""<button class= 'btn btn-primary' onClick='employee_statement("{party}")'>Statements</button>"""
	...
	def get_columns(self):
		...
		if self.party_naming_by == "Naming Series":
			self.add_column(_("{0} Name").format(self.party_type), fieldname="party_name", width=500, fieldtype="Data")
		self.add_column(_("Empoyee Name"), fieldname="employee_name", width=500,fieldtype="Data")
